...
test('quotes(value)', function(t) {
  ...
  t.deepEqual(
    retext()
      .use(quotes)
      .processSync(moreApostrophes).messages,
    [],
  ...
  t.deepEqual(
    retext()
      .use(quotes)
      .processSync('“Open this, ‘Open that, “open here, ‘open there').messages,
    [],
